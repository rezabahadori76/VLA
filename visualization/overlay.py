...
def render_perception_overlay(states: List[FrameWorldState], frames_dir: Path, output_dir: Path, draw_masks: bool, draw_boxes: bool) -> None:
    ...
    for st in states:
        ...
        if draw_boxes:
            for det in st.detections:
                ...
                cv2.putText(img, f'{det.label}:{det.score:.2f}', (x1, max(12, y1 - 6)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 120, 0), 1)
